...
const works = [
  {
      ...
      to: "2019",
      present: false,
      image: "https://localhost:3000/tigyapp_web_image.jpg",
      ...
      to: "",
      present: true,
      image: "https://localhost:3000/ca_web_image.jpg",
      ...
      to: "",
      present: true,
      image: "https://localhost:3000/nextca_web_image.jpg",
      ...
      to: "09/2015",
      present: false,
      image: "https://localhost:3000/ppastries_web_image.jpg",
      ...
      to: "2019",
      present: false,
      image: "https://localhost:3000/softars_web_image.jpg",
      ...
      to: "2019",
      present: false,
      image: "https://localhost:3000/minami_web_image.jpg",
      ...
      to: "2019",
      present: false,
      image: "https://localhost:3000/minami_careers_web_image.jpg",
      ...
      to: "2019",
      present: false,
      image: "https://localhost:3000/fonselp_web_image.jpg",
