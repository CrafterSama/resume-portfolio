...
import tigyImg from '../../static/images/tigyapp_web_image.png';
import oldCaImg from '../../static/images/ca_web_image.png';
import caImg from '../../static/images/nextca_web_image.jpg';
import ppastriesImg from '../../static/images/ppastries_web_image.png';
import softarsImg from '../../static/images/softars_web_image.png';
import minamiImg from '../../static/images/minami_web_image.png';
import minamiCareersImg from '../../static/images/minami_careers_web_image.png';
import fonselpImg  from '../../static/images/fonselp_web_image.png';

const works = [
            {
                name: "Phinx - Software Lab",
                description: "Work in Phinx develop a CRM to maintain a Storage of a Hardware division.",
                type: "Web App",
                version: "1.0",
                technologies: "React + Hooks, Redux, React Router Dom, CSS3, HTML5, Javascript",
                from: "February 2020",
                to: "2020",
                present: false,
                image: "../static/images/tigyapp_web_image.png",
            ...
            },{
            {
                ...
                to: "",
                present: true,
                image: "../static/images/ca_web_image.png",
                ...
                to: "",
                present: true,
                image: "../static/images/nextca_web_image.jpg",
                ...
                to: "09/2015",
                present: false,
                image: "../static/images/ppastries_web_image.png",
                ...
                to: "2019",
                present: false,
                image: "../static/images/softars_web_image.png",
                ...
                to: "2019",
                present: false,
                image: "../static/images/minami_web_image.png",
                ...
                to: "2019",
                present: false,
                image: "../static/images/minami_careers_web_image.png",
                ...
                to: "2019",
                present: false,
                image: "../static/images/fonselp_web_image.png",
