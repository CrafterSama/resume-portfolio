...
import sfotarsImg from '../../static/images/softars_web_image.jpg'
...
const works = [
  {
      ...
      to: "2019",
      present: false,
      image: "minami_careers_web_image.jpg",
