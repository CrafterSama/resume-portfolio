...
const experiences = [/* {
    ...
    },
    {
        ...
        state: "",
        city: "Santiago",
        tasks: "I Lead the Technicak Dep and change the way to Develop in PHP, Implementation of Laravel and VueJS to create a better CRM to attend clients in restaurants trough a mobile application",
        uuid: ""
    },
    {
