...
const skills = [
  ...
  },
  {
    ...
    description:
      'React, Redux, React Native, VueJS, Laravel, Django, SASS, LESS, MaterialUI for React, Bootstrap, Materialize CSS, Bulma CSS, JQuery.',
  },
  {
    name: 'Database Management',
    description:
      'Database Design and Management, Data Analysis, MySQL/MariaDB, MongoDB, ORM(Eloquent/Doctrine), Mongoose',
  },
  {
    name: 'Research and Planning',
    description:
      'Identifying and Solve problems, Gathering Information, Developing solutions, Calculating results, Scrum',
  },
];
